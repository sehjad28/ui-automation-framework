...
package com.cinch.testautomation.ui.api;
...
public class CreateFLOServiceRequest {
    ...
    public Map<String, String> createServiceRequest(HashMap<String, String> servdetails) throws IOException {
        ...
        jsonObject.put("tradeLocationId", 1);
        jsonObject.put("tradeProblemCodeMapId", 11);
        ...
        jsonObject.put("specialInstructions", "call upon arrival");
        ...
        jsonObject.put("affinityPartner", 116);
        jsonObject.put("serviceJobTypeId", 2);
        jsonObject.put("source", "Agent-Accelerate");
        jsonObject.put("channel", "Web");
        jsonObject.put("secondaryEmail", faker.internet().emailAddress());
        jsonObject.put("addressType", 1);
        jsonObject.put("forceBook", "Not ready");
        jsonObject.put("serviceJobUrgency", "Emergency");
...
/*        int statusCode = response.getStatusLine().getStatusCode();
    ...
    public static void main(String[] args) throws IOException {
        CreateFLOServiceRequest csj = new CreateFLOServiceRequest();
        HashMap<String, String> hashMap = new HashMap<>();
        hashMap.put("scheduledServiceDate", "2020-11-21");
